...
def get_names(file_name):
  ...
  for line in leaderboard_file:
    ...
    while (line[index] != ","):
      ...
      index = index + 1
    print("The Leader's Name Is:", leader_name)
...
def get_scores(file_name):
  ...
  for line in leaderboard_file:
    ...
    while (line[index] != "\n"):
      ...
      index = index + 1
    print("The Leader's Score Is:", int(leader_score))
...
def draw_leaderboard(high_scorer, leader_names, leader_scores, turtle_object, player_score):
  ...
  turtle_object.color("black")
  bronze_score = int(scores[2])
  silver_score = int(scores[1])
  gold_score = int(scores[0])
  print("The Real Leader's Last Name Is: " + str(names[0]) + " With a Score of " + str(scores[0]))
  if (player_score >= gold_score):
    ...
    turtle_object.write(" ", font=font_setup)